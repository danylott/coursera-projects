...
class ProgressBar(ScreenHandle):
    ...
    def draw(self, canvas):
        ...
        self.blit(font.render(f'Agility: ', True, colors["black"]),
                  (350, 55))
        self.blit(font.render(f'{self.engine.hero.stats["agility"]}', True, colors["black"]),
                  (440, 55))

        self.blit(font.render(f'Intellect: ', True, colors["black"]),
                  (350, 80))
...
class HelpWindow(ScreenHandle):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.data.append(["ryabov", "OOP final project"])
