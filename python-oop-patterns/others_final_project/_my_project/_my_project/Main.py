...
pygame.display.set_caption("Ryabov RPG Game")
...
base_stats = {
    "strength": 15,  # Сила - основная характеристика
    "perception": 4,  # Восприятие- основная характеристика
    "endurance": 8,  # Выносливость- основная характеристика
    "charisma": 2,  # Харизма- основная характеристика
    "intelligence": 3,  # Интеллект- основная характеристика
    "agility": 8,  # Ловкость- основная характеристика
    "luck": 1  # Удача - основная характеристика
}
